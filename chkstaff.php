...
include('connection.php');
	echo '<font size="6" face="Hectiva" color="navy" style=" text-shadow: 1px 1px;text-align:center"><b> Staff</b></font>';
$q1="SELECT * FROM `reqstaff`";
...
$result1=$r1->num_rows;
	...
	while($row1=mysqli_fetch_assoc($r1))
	{
		...
		echo '	<div class="card-title"><b>Year of Joining: </b>'.$year.'</div>';
		echo '	<div class="card-title"><b>Department: </b>'.$dept.'</div></div>';
    ?>
		<div class="twobutton">
    <button style="	  background-color: red	"><a href="accstaff.php?username=<?php echo $username;?>" >Accept</a></button>
    <button style="	  background-color: green	;"><a href="rejstaff.php?username=<?php echo $username;?>" >Reject</a></button>
</div></div>
    	<?php
    	}
        ?>
