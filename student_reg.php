...
<body>
 ...
 <form method="POST" onsubmit="return validation()" enctype="multipart/form-data" action="studentreq.php" target="_top">
  ...
  <input type="TEXT" name="fname" value="" id="f1">
    ...
    <span id="U2"  style="color:red"></span></div>
    <div class="input-group">
      <label>Email</label>
    ...
    <div class="input-group">
      ...
      <div class="input-group"> <br>
        <button type="submit" class="btn" name="reg_user" id="pop">Register </button>
      </div>
      <p> <br>
