...
include('connection.php');
	echo '<font size="6" face="Hectiva" color="navy" style=" text-shadow: 1px 1px;text-align:center"><b>Student</b></font>';
$q1="SELECT * FROM `reqstudent`";
...
$result1=$r1->num_rows;
    ...
    ?>
		<div class="twobutton">
    <button style="	  background-color: red	"><a href="accstudent.php?username=<?php echo $username;?>" >Accept</a></button>
    <button style="	  background-color: green	;"><a href="rejstudent.php?username=<?php echo $username;?>" >Reject</a></button>
</div></div>
    	<?php
    	}
        ?>
